...
# :D
print(ggplot(aes(x='datetime', y='sentiment', color='senderName'), data=df3[df3.conversationWithName.str.contains('Ralu')][df3.sentiment != 0]) + geom_point(
    alpha=0.05) + scale_x_date(labels='%b %Y') + stat_smooth(method='loess'))
