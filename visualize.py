...
class ArgParse():
    ...
    def breakdown(self):
        ...
        parser.add_argument('-b', '--bin-size', dest='bin_size', type=str, default='1M', help='Bin sizes (use the pandas Timedelta abbreviations of the form <number><type> where type can be ‘Y’, ‘M’, ‘W’, ‘D’, ‘days’, ‘day’, ‘hours’, hour’, ‘hr’, ‘h’, ‘m’, ‘minute’, ‘min’, ‘minutes’, ‘T’, ‘S’, ‘seconds’, ‘sec’, ‘second’, ‘ms’, ‘milliseconds’, ‘millisecond’, ‘milli’, ‘millis’, ‘L’, ‘us’, ‘microseconds’, ‘microsecond’, ‘micro’, ‘micros’, ‘U’, ‘ns’, ‘nanoseconds’, ‘nano’, ‘nanos’, ‘nanosecond’, ‘N’).')
    ...
    def cloud(self):
        ...
        parser.add_argument('--sw', '--stopword-paths', dest='stopword_paths', nargs='+', default=['stopwords/en.json'], help='Path to stopword files (JSON format)')
